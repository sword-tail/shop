<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\wamp64\www\thinkp5b2c\b2c\public/../application/admin\view\article\edit.htm";i:1600232451;s:66:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\top.htm";i:1596607931;s:67:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\left.htm";i:1600229944;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cate_id">
                                                    ...
                                                    <option <?php if($arts['cate_id'] == $cate['id']): ?> selected="selected" <?php endif; ?>value="<?php echo $cate['id']; ?>"><?php echo str_repeat('-', $cate['level']*8)?><?php echo $cate['cate_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right:10px ">
                                                    <label>
                                                        <input type="radio" name="show_top" value="1" <?php if($arts['show_top'] == 1): ?>  checked="checked"<?php endif; ?>>
                                                        <span class="text">是</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left; padding-right:10px">
                                                    <label>
                                                        <input type="radio" name="show_top"  value="0" <?php if($arts['show_top'] == 0): ?>  checked="checked"<?php endif; ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="descripition"  ><?php echo $arts['descripition']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">作者</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $arts['author']; ?>" placeholder="" name="author"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">邮箱</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $arts['email']; ?>" placeholder="" name="email"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">外链</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $arts['link_url']; ?>" placeholder="" name="link_url"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <?php if($arts['thumb'] != ''): ?>
                                                <img height="30" src="/thinkp5b2c/b2c/public/uploads/<?php echo $arts['thumb']; ?>" alt="">
                                                <?php else: ?>
                                                暂无缩略图
                                                <?php endif; ?>
                                            </div>
...
<script type="text/javascript">
    var ue = UE.getEditor('content' ,{ initialFrameHeight:300  , autoHeightEnabled: false});
</script>
