<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp64\www\thinkp5b2c\b2c\public/../application/admin\view\attr\list.htm";i:1601356144;s:66:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\top.htm";i:1596607931;s:67:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\left.htm";i:1602823761;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加品牌" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Attr/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <tbody>
                            <?php if(is_array($attrRes) || $attrRes instanceof \think\Collection || $attrRes instanceof \think\Paginator): $i = 0; $__LIST__ = $attrRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?>
                               <tr>
                                   ...
                                   <td align="center"><?php if($attr['attr_type'] == 1): ?>单选<?php else: ?>唯一<?php endif; ?></td>
