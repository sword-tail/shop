<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\wamp64\www\thinkp5b2c\b2c\public/../application/admin\view\member_level\edit.htm";i:1602751444;s:66:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\top.htm";i:1596607931;s:67:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\left.htm";i:1602579675;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('Type/lst'); ?>">会员级别管理</a>
                    </li>
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">修改会员级别</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?php echo $member_levels['id']; ?>">
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">会员级别名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control"  value="<?php echo $member_levels['level_name']; ?>" placeholder="" name="level_name" required="" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">级别积分下限</label>
                                            <div class="col-sm-6">
                                                <input class="form-control"  value="<?php echo $member_levels['bom_point']; ?>" placeholder="" name="bom_point" required="" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">级别积分上限</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $member_levels['top_point']; ?>" placeholder="" name="top_point" required="" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">级别折扣率</label>
                                            <div class="col-sm-6">
                                                <input class="form-control"  value="<?php echo $member_levels['rate']; ?>"name="rate"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
