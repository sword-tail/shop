<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\wamp64\www\thinkp5b2c\b2c\public/../application/admin\view\cate\add.htm";i:1599467262;s:66:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\top.htm";i:1596607931;s:67:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\left.htm";i:1601016264;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right:10px ">
                                    <label>
                                        <input type="radio" name="show_nav" value="1" class="colored-blue">
                                        <span class="text">是</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left; padding-right:10px">
                                    <label>
                                        <input type="radio" name="show_nav" checked="checked" value="0" class="colored-blue">
