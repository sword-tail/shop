<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp64\www\thinkp5b2c\b2c\public/../application/admin\view\attr\edit.htm";i:1601363852;s:66:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\top.htm";i:1596607931;s:67:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\left.htm";i:1602823761;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  placeholder="" value="<?php echo $attrs['attr_name']; ?>" name="attr_name" required="" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right:10px ">
                                                    <label>
                                                        <input type="radio" name="attr_type" value="1" class="colored-blue" <?php if($attrs['attr_type'] == 1): ?> checked="checked" <?php endif; ?>>
                                                        <span class="text">单选</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left; padding-right:10px">
                                                    <label>
                                                        <input type="radio" name="attr_type"  value="2" class="colored-blue" <?php if($attrs['attr_type'] == 2): ?> checked="checked" <?php endif; ?>>
