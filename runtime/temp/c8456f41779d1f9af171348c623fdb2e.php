<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\wamp64\www\thinkp5b2c\b2c\public/../application/admin\view\member_level\list.htm";i:1602823806;s:66:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\top.htm";i:1596607931;s:67:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\left.htm";i:1602823761;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加品牌" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('MemberLevel/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                <th class="text-center" width="28%">ID</th>
                                <th class="text-center">会员级别名称</th>
                                <th class="text-center">会员级别下限</th>
                                <th class="text-center">会员级别上限</th>
                                <th class="text-center">折扣率</th>
                                <th class="text-center" width="16%">操作</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($member_levelRes) || $member_levelRes instanceof \think\Collection || $member_levelRes instanceof \think\Paginator): $i = 0; $__LIST__ = $member_levelRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ml): $mod = ($i % 2 );++$i;?>
                               <tr>
                ...
                <div>
                    <div style="padding-top:10px; text-align: right;">
                        <?php echo $member_levelRes->render(); ?>
                    </div>
                </div>
            </div>
        </div>
