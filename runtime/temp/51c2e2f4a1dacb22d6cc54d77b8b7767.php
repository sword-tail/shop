<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\wamp64\www\thinkp5b2c\b2c\public/../application/admin\view\brand\list.htm";i:1597119644;s:66:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\top.htm";i:1596607931;s:67:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\left.htm";i:1601016264;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="18%">品牌描述</th>
                        ...
                        <tbody>
                            <?php if(is_array($brandRes) || $brandRes instanceof \think\Collection || $brandRes instanceof \think\Paginator): $i = 0; $__LIST__ = $brandRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;?>
                               <tr>
                                   ...
                                   <td><a href="<?php echo $brand['brand_url']; ?>" target="_blank"><?php echo $brand['brand_url']; ?></a></td>
                                   <td align="center">
                                       <?php if($brand['brand_img'] !=  ''): ?>
                                        <img src="/thinkp5b2c/b2c/public/uploads/<?php echo $brand['brand_img']; ?>" height="30">
                                       <?php else: ?>
                                        暂无图片
                                       <?php endif; ?>
                                   </td>
                                   <td><?php echo sub_str($brand['brand_description'],15); ?></td>
                                   <td align="center">
                                    ...
                                    <td align="center">
                                    <a href="<?php echo url('edit',array('id' => $brand['id'])); ?>'" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id' => $brand['id'])); ?>')" class="btn btn-danger btn-sm shiny">
