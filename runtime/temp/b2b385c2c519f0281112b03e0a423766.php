<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\wamp64\www\thinkp5b2c\b2c\public/../application/admin\view\attr\add.htm";i:1601363120;s:66:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\top.htm";i:1596607931;s:67:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\left.htm";i:1602823761;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right:10px ">
                                    <label>
                                        <input type="radio" name="attr_type" value="1" class="colored-blue" checked="checked">
                                        <span class="text">单选</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left; padding-right:10px">
                                    <label>
                                        <input type="radio" name="attr_type"  value="2" class="colored-blue">
