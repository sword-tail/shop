<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp64\www\thinkp5b2c\b2c\public/../application/admin\view\cate\list.htm";i:1600409783;s:66:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\top.htm";i:1596607931;s:67:"D:\wamp64\www\thinkp5b2c\b2c\application\admin\view\common\left.htm";i:1600412139;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加品牌" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Cate/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <tbody>
                            <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                               <tr>
                                   ...
                                   <td align="center">
                                       <?php switch($cate['cate_type']): case "1": ?>系统分类<?php break; case "2": ?>帮助分类<?php break; case "3": ?>网店帮助<?php break; case "4": ?>网店信息<?php break; case "5": ?>普通分类<?php break; default: ?>系统
                                       <?php endswitch; ?>
                                   </td>
